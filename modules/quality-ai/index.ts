...
export async function evaluateBeforeAfter(
    ...
    messages: [
      {
        ...
        content: [
          ...
          { type: 'text', text: BEFORE_AFTER_EVALUATION_PROMPT(locationName, manualContext) },
        ],
      },
    ],
    response_format: { type: 'json_object' },
  ...
  // AI応答に validation / evaluationPossible がなければ保存禁止
