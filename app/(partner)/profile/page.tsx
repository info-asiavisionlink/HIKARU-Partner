...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-xl space-y-4">
      ...
      {/* 会社情報 */}
      <div className="rounded-2xl p-5 space-y-4" style={{ background: 'oklch(0.09 0.005 255 / 0.82)', border: `1px solid ${GOLD}18` }}>
        ...
        <div className="space-y-3 pt-2 border-t" style={{ borderColor: `${GOLD}10` }}>
          <div className="flex items-center gap-3">
